...
namespace jvk::shaders::defaults
{
static inline const int basic_vert_spvSize = 1052;
static inline const unsigned char __basic_vert_spv[] =
{ 3,2,35,7,0,0,1,0,11,0,13,0,31,0,0,0,0,0,0,0,17,0,2,0,1,0,0,0,11,0,6,0,1,0,0,0,71,76,83,76,46,115,116,100,46,52,53,48,0,0,0,0,14,0,3,0,0,0,0,0,1,0,0,0,15,0,9,0,0,0,0,0,4,0,0,0,109,97,105,110,0,0,0,0,13,0,0,0,18,0,0,0,27,0,0,0,29,0,0,0,3,0,3,0,2,0,0,0,
    ...
    0,1,0,56,0,1,0,0,0 };
static inline const char* basic_vert_spv = (const char*) __basic_vert_spv;

static inline const int basic_frag_spvSize = 452;
static inline const unsigned char __basic_frag_spv[] =
...
static inline const char* basic_frag_spv = (const char*) __basic_frag_spv;

} // jvk::shaders::defaults
